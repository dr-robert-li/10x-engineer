...
// runtime hook scripts (lib/hooks/session-start.js,
// lib/hooks/user-prompt-submit.js) into <homedir>/.codex/hooks/, writes a
...
// Build the runtime persona.txt — concatenated skill bodies the
// session-start hook reads at runtime. Identical shape to the parallel
// adapter's persona; the hook scripts are vendor-agnostic.
