#!/usr/bin/env node
// lib/hooks/session-start.mjs — session-start runtime persona injection.
//
...
// In production the installer copies this script into the harness-specific
// hooks directory under <homedir> alongside a persona.txt the same install
