...
//
// Phase 6 (HOOK-05): the CONVENTIONS.md body is prefixed with the canonical
// STATE_GATE_INSTRUCTION immediately after the header, so the runtime gate
// is the first thing the host encounters before any methodology content.
