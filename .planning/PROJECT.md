...
**Constraints inherited:** MIT, Node 18+, ESM, deps limited to `commander` (+ optionally `kleur`). Tarball <150KB. No telemetry, no network, no postinstall.
