...
- [x] **Phase 10: v1.0 Release** - Version bump 0.3.0 → 1.0.0, CHANGELOG, README build-mode section, tarball verification, git tag/push/GitHub release (completed 2026-05-09)
...
| 10. v1.0 Release | 5/5 | Complete   | 2026-05-09 |
...
- [x] 10-05-PLAN.md (Wave 5, has checkpoint) — D-11 verification gate + v1.0.0 git tag + manual handoff (push main, push tag, gh release create)
**UI hint**: no
